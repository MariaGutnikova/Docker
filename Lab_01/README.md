...
### Вариант 2
#### 	**Реляционная БД.** Запустить контейнер, задать пароль root через переменную MYSQL_ROOT_PASSWORD. Подключиться к БД из терминала контейнера и создать тестовую базу данных sales.

Запуск контейнера mysql
<img width="897" height="796" alt="image" src="https://github.com/user-attachments/assets/b10c963f-c669-4f3d-8c0d-66d7947fb639" />


Установка пароля:
<img width="302" height="43" alt="image" src="https://github.com/user-attachments/assets/98404e41-e1b8-459a-92e2-3b1c8f4898e0" />

Создание БД sales
<img width="903" height="679" alt="image" src="https://github.com/user-attachments/assets/57bcfeb9-59a0-4e70-aec1-31002171e5ea" />

Остановка контейнера, проверка
<img width="900" height="116" alt="image" src="https://github.com/user-attachments/assets/43c944be-dbc6-4f8c-871f-fbdb94ddf8ac" />

Работа через файл .sh
<img width="1919" height="1120" alt="image" src="https://github.com/user-attachments/assets/eccdf366-11d3-417b-98e9-2528045d5e2b" />
